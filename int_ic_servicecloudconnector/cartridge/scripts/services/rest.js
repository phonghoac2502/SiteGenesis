...
const serviceIDs = {
    auth: 'servicecloud.rest.auth',
    create: 'servicecloud.rest.create',
    get: 'servicecloud.rest.get',
    query: 'servicecloud.rest.query',
    patch: 'servicecloud.rest.patch',
    put: 'servicecloud.rest.put',
    remove: 'servicecloud.rest.remove'
};

const servicePaths = { 
    get: {
        account: '/services/apexrest/v1/ICConnector/Customer/{0}', //remove
        case: 'services/apexrest/NSSCCConnector/Case/{0}',
        ...
        customerAddress: 'services/apexrest/v1/ICConnector/Customer/{0}/AddressBook'
    },
    create: {
        account: '/services/apexrest/v1/ICConnector/Customer', //remove
        case: 'services/apexrest/NSSCCConnector/Case',
        order: '/services/apexrest/v1/ICConnector/Order',
        contact: '/services/apexrest/v1/ICConnector/Customer',
        customerAddress: 'services/apexrest/v1/ICConnector/Customer/{0}/AddressBook'
    },
    update: {
    	account: '/services/apexrest/ICConnector/{0}',
        case: 'services/apexrest/NSSCCConnector/Case',
        order: '',
        contact: '/services/apexrest/v1/ICConnector/Customer/{0}',
        customerAddress: 'services/apexrest/v1/ICConnector/Customer/{0}/AddressBook/{1}',
        refund: 'services/apexrest/v1/ICConnector/Refund/{0}'
    },
    remove: {
        customerAddress: 'services/apexrest/v1/ICConnector/Customer/{0}/AddressBook/{1}'
    }
...
serviceConfigs[serviceIDs.remove] = {
	/**
     * Query records
     * @param {dw.svc.HTTPService} svc
     * @param {String} urlPath
